...
import { addStudent, type ManageState } from "@/app/admin/students/actions";
...
export function AdminStudentForm() {
  const [state, formAction, pending] = useActionState(addStudent, initial);

  return (
    <form action={formAction} className="rounded-3xl bg-surface p-7 shadow-[0_10px_40px_rgba(19,48,41,0.05)]">
      <h2 className="font-display text-xl font-semibold text-ink">Add a student</h2>
